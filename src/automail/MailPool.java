...
public class MailPool {
	...
	public class ItemComparator implements Comparator<Item> {
		...
		public int compare(Item i1, Item i2) {
			int order = 0;
			double i1Cost = i1.mailItem.getFeeCalculator().calcCost();
			double i2Cost = i2.mailItem.getFeeCalculator().calcCost();
			double threshold = Simulation.getCHARGE_THRESHOLD();
			
			if (i1Cost > threshold && i2Cost < threshold) {
				return -1;
			} else if (i1Cost < threshold && i2Cost > threshold) {
				return 1;
			}
